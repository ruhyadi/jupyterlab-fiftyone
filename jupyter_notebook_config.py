...
#  password.
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$7bSZq3ZXFg/pB6WtwNwiJA$flgFFJQfeIbhgrYaJ0YW7sXHR1aJNyevGxiUjwvUBCs'
...
#  Choices: any of ['sha3_384', 'blake2s', 'sha1', 'sha256', 'sha3_512', 'blake2b', 'md5', 'sha384', 'sha3_256', 'sha3_224', 'sha512', 'sha224']
#  Default: 'sha256'
